...
/**
 * <b>Ein-/Ausgabe �ber Sockets</b>. <br /> Ein Objekt der Klasse Socket kapselt
 * eine Socket-Schnittstelle. Festlegung der Socket-Parameter kann nur bei der
 * Objekt-Erzeugung vorgenommen werden.<br />
 * <br /> Das Socket-Objekt kann sich mit einem Server-Socket. Ob die
 * Verbindungsanforderung erfolgreich war, kann durch den R�ckgabewert der Methode
 * {@link Socket#connect connect()} festgestellt werden (true, wenn die Verbindung
 * akzeptiert wurde).<br />
 * <br /> Das Socket-Objekt gestattet im Zustand "verbunden" das Lesen bzw.
 * Schreiben von einzelnen Bytes, Byte-Arrays oder Strings von der bzw. auf die
 * Socket-Schnittstelle.<br />
 * <br /> Copyright 2006, Michael Zimmer<br />
 * <br />
 * @see ServerSocket
 * @author Michael Zimmer
 * @version 1.1 (Mo, 13.03.2006, 17:42 MEZ)
 * @updated 18-Jun-2014 08:05:29
 */
public class Socket {
    ...
    // Hinzugefügt am 28.11.2024 M.Schulz
